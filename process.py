...
class EventProcessor:
    ...
    def process(self):
        ...
        self.shots = self.shots.drop(["event_type2", "player2", "player_in", "player_out"], axis=1)
        # remove envent_type when is na
        self.shots.dropna(subset=["player", "shot_outcome", "shot_place"], inplace=True)
